...
class CountryRepository implements CountryRepositoryInterface
{
    ...
    protected $availableLocales = [
        ...
        'ja', 'jgo', 'jmc', 'jv', 'ka', 'kab', 'kam', 'kde', 'kea', 'khq',
        'ki', 'kk', 'kln', 'km', 'kn', 'ko', 'ko-KP', 'kok', 'ks', 'ksb', 'ksf',
        'ksh', 'ku', 'ky', 'lag', 'lb', 'lg', 'ln', 'lo', 'lt', 'lu', 'luo',
        'luy', 'lv', 'mas', 'mer', 'mfe', 'mg', 'mgh', 'mk', 'ml', 'mn', 'mr',
        'ms', 'mt', 'mua', 'my', 'mzn', 'naq', 'nb', 'nd', 'ne', 'nl', 'nmg',
        'nn', 'nyn', 'or', 'pa', 'pl', 'ps', 'ps-PK', 'pt', 'pt-PT', 'qu',
        'rm', 'rn', 'ro', 'ro-MD', 'rof', 'ru', 'ru-UA', 'rwk', 'saq', 'sbp',
        'sd', 'se', 'se-FI', 'seh', 'ses', 'sg', 'shi', 'shi-Latn', 'si', 'sk',
        'sl', 'smn', 'sn', 'so', 'sq', 'sr', 'sr-Cyrl-BA', 'sr-Cyrl-ME',
