...
Countries are generated from [CLDR](http://cldr.unicode.org) v41. Address formats and subdivisions are generated from Google's [Address Data Service](https://chromium-i18n.appspot.com/ssl-address).
